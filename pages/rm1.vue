...
<v-col class="pt-2" v-if="response">
    ...
    <v-toolbar flat color="transparent">
        <div class="flex">
            ...
            <v-btn color="primary" text>RM-Plan /</v-btn>
        </div>
        <v-spacer></v-spacer>
    </v-toolbar>
    <div class="pl-6"> 
        <h2 class="text-2xl">แผนการบริหารจัดการความเสี่ยงและควบคุมภายใน (RM-Plan)</h2>
        <span class=" ">{{risk.name}} </span>
        <!-- <v-btn @click="report.openReport(risk.id)" color="success">text</v-btn> -->
    </div>
