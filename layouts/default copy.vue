<template>
  <v-app dark>
    <Core-Navbar @callback="checkUser"></Core-Navbar>
    ...
    <v-main  style="z-index:1;" class="relative      bg-gray-200">
      <v-container v-if="response">
          <Core-Bg></Core-Bg>
        <nuxt class="relative" />
      </v-container>
    </v-main>     <div class="grid grid-cols-1 lg:grid-cols-2 p-4 gap-4">
                        ...
                        <div class="relative flex flex-col min-w-0 mb-4 lg:mb-0 break-words bg-gray-50 dark:bg-gray-800 w-full shadow-lg rounded">
                            <div class="rounded-t mb-0 px-0 border-0 " >
                                ...
                                <div class="flex block overflow-x-auto">
                                        ...
                                        <div class="text-gray-500 dark:text-gray-200 mt-2 ml-2 flex justify-between items-start">
                                            <span class="text-xs flex items-center">
                                                <svg class="h-4 fill-current mr-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50">
                                                    <path d="M11 4c-3.855 0-7 3.145-7 7v28c0 3.855 3.145 7 7 7h28c3.855 0 7-3.145 7-7V11c0-3.855-3.145-7-7-7zm0 2h28c2.773 0 5 2.227 5 5v28c0 2.773-2.227 5-5 5H11c-2.773 0-5-2.227-5-5V11c0-2.773 2.227-5 5-5zm25.234 9.832l-13.32 15.723-8.133-7.586-1.363 1.465 9.664 9.015 14.684-17.324z"></path>
                                                </svg>
                                                3/5
                                            </span>
                                        ...
                                        <div class="flex justify-between items-start mt-2 ml-2 text-white text-xs">
                                            <span class="bg-pink-600 rounded p-1 text-xs flex items-center">
                                                <svg class="h-4 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                                    <path d="M12 2c-.8 0-1.5.7-1.5 1.5v.688C7.344 4.87 5 7.62 5 11v4.5l-2 2.313V19h18v-1.188L19 15.5V11c0-3.379-2.344-6.129-5.5-6.813V3.5c0-.8-.7-1.5-1.5-1.5zm-2 18c0 1.102.898 2 2 2 1.102 0 2-.898 2-2z"></path>
                                                </svg>
                                                2
                                            </span>
                                        </div>
    ...
    <!-- <v-footer
      ...
      app
    >
      <span class="text-purple-800">&copy; {{ new Date().getFullYear() }} กองแผนงาน มหาวิทยาลัยพะเยา </span>
    </v-footer> -->
  </v-app>
</template>
...
@import url('https://fonts.googleapis.com/css2?family=IBM+Plex+Sans+Thai:wght@300&family=Noto+Sans+Thai+Looped:wght@100&display=swap');
*{
