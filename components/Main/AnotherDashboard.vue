...
<v-col>
    <v-toolbar color="transparent" flat>
       ...
       <Core-AgencySelect :allCheck="true"   class="ml-4" @allChange="allChange" @agencyChange="agencyChange"></Core-AgencySelect>
    ...
    <div v-if="response">
        ...
        <div class="w-full mt-4">
           ...
           <RM-ListStrategicOnlyAgency class="mt-4" :agency="agency" @loadRisk="agencyChange" />
