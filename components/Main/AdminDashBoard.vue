...
<v-col>
    <v-toolbar color="transparent" flat>
        ...
        <Core-AdminAgencySelect v-if="user.is_staff || user.is_superuser" class="ml-4" @allChange="allChange" @agencyChange="agencyChange"></Core-AdminAgencySelect>
    ...
    <div v-if="response">
        ...
        <div class="w-full mt-4">
           ...
           <RM-ListStrategic0 class="mt-4" :agency="agency" @loadRisk="agencyChange" />
...
export default class UserDashBoard extends Vue {
    ...
    private agency: number = Auth.user.agency_id
